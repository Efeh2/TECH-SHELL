...
const Navbar = () => {
    ...
    const navLinks = ['Home', 'Shop', 'Collection', 'Sales', 'Deals'];
  return (
                        ...
                        {navLinks.map((link) => (
                            ...
                            className={`relative font-medium
                                ...
                                ${
                                    ...
                                    {link}
                        {(hoveredLink === link || activeLink === link) && (
                  ...
                  <button className='hover:opacity-70 transition-opacity relative'>
                    ...
                    <button className='hover:opacity-70
                        transition-opacity relative'>
                            ...
                            bg-white text-gray-900 text-xs
                            rounded-full w-4 h-4 flex flex-center
                ...
                border-white/20'>
                    <div className='flex flex-col gap-3 text-white'>
                        {navLinks.map((link) => (
                            ...
                            className={`py-2 relative transition-opacity
                            hover:opacity-70 ${
                                activeLink === link ? 'opacity-100'
                                : 'opacity-80'
                            }`}>
                                {link}
                            </a>
